...
$config['licenseName'] = '1GZGMGBWP7PH6QP8PVG64Z656USJ3';
$config['licenseKey']  = 'F5T58S2EUGLVJV4WKUU1UT3DDXGG2';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => strstr($_SERVER["PHP_SELF"], 'public', true) . 'public/img/',
